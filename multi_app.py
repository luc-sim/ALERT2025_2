...
from commands import cyclic2
from commands import cyclic1
...
with col2:
    edis = st.number_input("", min_value=0.01, max_value=0.5, value=0.03, step=0.01, label_visibility="collapsed")
